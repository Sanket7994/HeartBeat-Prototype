...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='patientappointment',
            name='procedures',
            field=models.JSONField(blank=True, default=None, max_length=250, null=True),
        ),
        migrations.AddField(
            model_name='patientappointment',
        ...
        migrations.AlterField(
            model_name='drug',
            name='drug_id',
            field=models.CharField(default='965A5C997B', editable=False, max_length=50, primary_key=True, serialize=False, unique=True),
        ),
        migrations.AlterField(
            model_name='patientappointment',
            name='appointment_id',
